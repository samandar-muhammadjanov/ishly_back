...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="accounts_ot_phone_n_27f08e_idx",
                    ),
                    models.Index(
                        fields=["expires_at"], name="accounts_ot_expires_620a99_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="accounts_de_user_id_165b7a_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["phone_number"], name="accounts_us_phone_n_51de17_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["role", "is_active"], name="accounts_us_role_1bca3d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["created_at"], name="accounts_us_created_7b05cd_idx"
            ),
        ),
    ]
